...
public class Zad3 implements GLEventListener, MouseListener, MouseMotionListener {
    private static double viewer[] = {0.0, 0.0, 10.0};
    private static float thetaX = 0.0f;
    private static float thetaY = 0.0f;
    private static float thetaZoom = 0.0f;
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (status == 1) {
            ...
            thetaZoom += deltaZoom * pix2angle;

        }

        gl2.glRotated(thetaX, 0.0, 1.0, 0.0);
        gl2.glRotated(thetaY, 1.0, 0.0, 0.0);
        gl2.glRotated(thetaZoom, 0.0, 0.0, 0.0);
    ...
    public void mouseReleased(java.awt.event.MouseEvent e) {
        ...
        else if (e.getButton() == MouseEvent.BUTTON3) status = 0;
    }
